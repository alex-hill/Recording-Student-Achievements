                            ...
                            switch (subject)
                            {
                                ...
                                case "Reading":
                                    ...
                                    cmd.CommandText = "INSERT INTO Reading (NSN, [Reading Initial Assessment Method], [Reading Initial Assessment Level], [Reading Final Assessment Method], [Reading Final Assessment Level], [Reading NS Achievement Code], " +
                                        "[Reading NS Progress], [Reading Effort], [Reading Comment]) VALUES(" + values[0] + ", [" + values[1] + "], [" + values[2] + "], [" + values[3] + "], [" + values[4] + "], [" + values[5] + "], [" + values[6] + "], [" + values[7] + "], [" + values[8] + "]);";
                                    ...
                                    cmd.Parameters.AddWithValue("@Reading Effort", values[7]);
                                ...
                                case "Writing":
                                    ...
                                    cmd.CommandText = "INSERT INTO Writing (NSN, [Writing Initial Assessment], [Writing Final Assessment], [Writing NS3 Code], [Writing NS Achievement Code], [Writing NS Progress Code], " +
                                        "[Writing Effort], [Writing Comment]) VALUES(" + values[0] + ", [" + values[1] + "], [" + values[2] + "], [" + values[3] + "], [" + values[4] + "], [" + values[5] + "], [" + values[6] + "], [" + values[7] + "]);";
                                    ...
                                    cmd.Parameters.AddWithValue("@Writing Effort", values[6]);
                                ...
                                case "Mathematics":
                                    ...
                                    cmd.Parameters.AddWithValue("@Math Effort", values[7]);
                                    ...
                                    cmd.CommandText = "INSERT INTO Mathematics (NSN, [Math Initial Assessment Method], [Math Initial Assessment Level], [Math Final Assessment Method], [Math Final Assessment Level], [Math Overall Assessment], " +
                                        "[Math NS Achievement Code], [Math NS Progress Code], [Math Effort], [Math Comment], [Math KF1], [Math KF2], [Math KF3], [Math KF4], [Math NS1], [Math NS2]) "
                                        ...
                                        +"[@Math NS Progress Code], [@Math Effort], [@Math Comment], [@Math KF1], [@Math KF2], [@Math KF3], [@Math KF4], [@Math NS1], [@Math NS2]); ";
